...
Route::post('task-lists/{task}/move', 'TaskListController@move')->name('task-lists.move');
Route::post('task-lists/{task}/favorite', 'TaskListController@favorite')->name('task-lists.favorite');
Route::post('task-lists/{task}/hide', 'TaskListController@hide')->name('task-lists.hide');
